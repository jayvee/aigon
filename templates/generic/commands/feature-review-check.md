...
If `{{ARG1_SYNTAX}}` is non-empty, use it as the feature ID and skip to Step 1.
...
> Can't infer feature ID — run this inside the feature worktree, or pass an explicit ID (e.g. `{{CMD_PREFIX}}feature-review-check 230`).
