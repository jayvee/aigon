...
```json
{ "worktreeSetup": "<repo-specific setup command>" }
```

or, when your repo can safely share prepared artifacts from the main checkout:

```json
{ "worktreeSetup": "<repo-specific artifact link command>" }
```
