...
When autonomous state is active, the feature card and detail drawer expose a **Stop automation** action. That action calls `feature-autonomous-stop` under the hood.
