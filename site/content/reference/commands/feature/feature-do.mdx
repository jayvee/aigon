...
```bash
aigon feature-do <ID> [--agent=<cc|ag|cx|cu>] [--iterate] [--max-iterations=N] [--auto-submit] [--no-auto-submit] [--dry-run]
```
...
| Flag | Description |
|------|-------------|
| `--agent=<cc\|ag\|cx\|cu>` | Override agent detection (useful when branch name is ambiguous) |
