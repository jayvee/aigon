...
If a PR is open when you run `feature-close`, Aigon will block and tell you to merge or close the PR first. See the [GitHub Integration](/docs/guides/github-integration) guide for the full flow.
