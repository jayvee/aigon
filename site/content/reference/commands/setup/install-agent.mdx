...
aigon install-agent cc ag cx cu op km am --force
```

Agent IDs come from `templates/agents/*.json` in the Aigon package. Current bundled IDs include `cc`, `ag`, `cx`, `cu`, `op`, `km`, and `am`.
