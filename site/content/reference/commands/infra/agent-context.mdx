...
Detects and prints the current Aigon agent host, such as `cc`, `ag`, `cx`, or `cu`. This is useful inside agent prompts and slash commands that need to bootstrap `AIGON_AGENT_ID` without parsing process names themselves.
