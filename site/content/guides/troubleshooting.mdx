...
**You want to:** close a feature, but `feature-close` fails because `main` has moved ahead of the feature branch.

**What it means:** `feature-close` requires the feature branch to be rebased onto the latest `main` before merging.
