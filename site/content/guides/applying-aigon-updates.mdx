...
- **Agent sessions** (Claude Code, Antigravity, Codex, Cursor, Kimi, OpenCode, Amp, GitHub Copilot) — a short notice at session start.
...
You can re-print it at any time with [`aigon installed-notice`](/docs/reference/commands/setup/installed-notice).
...
- [`installed-notice`](/docs/reference/commands/setup/installed-notice)
