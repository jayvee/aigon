...
Moves the feature to `02-backlog/`; the permanent `F<ID>` was allocated at create time.
...
- **Wait** — let the agent work and check back when it signals `implementation-complete`
