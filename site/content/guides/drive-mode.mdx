...
- You start the feature — the agent codes in a branch or worktree
...
Creates the workspace, opens a tmux session, and launches the agent. The agent starts implementing immediately — reading the spec, creating tasks from acceptance criteria, and writing code.

### 4. Work

The agent implements the feature. You can:
