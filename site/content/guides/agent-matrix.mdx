...
These badges appear alongside the ranked choices in the start modal.
...
The Settings matrix presents these operation scores and marks quarantined models with a warning.
