...
- **Commits** — commits over time with Daily/Weekly/Monthly toggle, per-commit stats (files changed, lines added/removed), and feature-to-commit linking via branch names
- **AI Attribution** — commits classified as AI-authored, human-authored, or mixed based on Co-authored-by trailers and agent email conventions
