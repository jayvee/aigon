---
title: Aigon Sync
description: Push portable Aigon state to a private Git vault — multi-machine sync (dashboard Settings → Aigon Sync).
---
...
It is not the only way to back things up — you can always copy repos, zip folders, or rely on host backups. Aigon Sync adds **hosted Git coordination** for Aigon-specific state, and is entirely optional.
