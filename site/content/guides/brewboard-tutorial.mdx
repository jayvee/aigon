...
<img src="/img/tutorial-drive-mode.png" alt="Drive mode agent picker — feature 01 dark-mode with Claude Code selected" width="420" style={{borderRadius:"8px",margin:"12px 0"}} />
