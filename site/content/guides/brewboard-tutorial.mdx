...
`aigon apply` creates the `docs/specs/` folder structure on first run and rebuilds the pre-seeded feature manifests. `install-agent` writes slash commands, hooks, and permissions for your chosen agent.
