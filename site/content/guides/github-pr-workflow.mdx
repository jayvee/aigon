...
This pushes the feature branch to `origin` with upstream tracking. From a worktree, it auto-detects the branch. From the main repo, pass the feature ID: `aigon feature-push 07`.
