...
description: How Aigon uses the filesystem as a state machine for workflow management.
---

Aigon implements spec-driven AI development using Git and the filesystem as the foundation. All workflow state lives in your repository as Markdown files.
...
All workflow state lives in `docs/specs/`, organised into three pillars:
