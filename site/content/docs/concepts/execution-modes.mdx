...
Aigon uses four modes across two axes: number of agents and level of autonomy.
...
- Command: `aigon feature-start 07 cc gg cx`
...
- Workspace: branch or worktree
- Command: `aigon feature-do 07 --autonomous`
...
- Workspace: one worktree per agent
- Command: `aigon feature-start 07 cc gg --autonomous --auto-submit`
