...
# → Creates .aigon/worktrees/feature-42-ag-dark-mode/
```
...
When you close a feature or an agent signals `implementation-complete`, Aigon runs security scanners against the changed files before merging:
...
- When each agent started and signalled completion
...
- **[Evaluation](/docs/concepts/evaluation)** — comparing implementations after agents signal completion
