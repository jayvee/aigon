...
| Status | Meaning |
|--------|---------|
| **Alive** | Heartbeat received within the last 60 seconds |
| **Stale** | No heartbeat for 60-120 seconds — agent may be thinking or stuck |
| **Dead** | No heartbeat for 120+ seconds — session likely ended |
