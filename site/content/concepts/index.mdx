...
Research supports Drive (one agent) and Fleet (multiple agents for diverse perspectives). There is no autopilot or evaluation step — research is evaluated, not scored.
