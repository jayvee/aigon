...
| **Example** | `/aigon:feature-do 07` or `$aigon-feature-do 07` | `aigon feature-start 07 cc gg` | Click "Start feature" on a kanban card |

All three surfaces drive the same underlying workflow. Mix them freely.

### Codex example

In a Codex session, use the `$aigon-...` skill syntax:
