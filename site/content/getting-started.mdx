...
```bash
aigon config set --global terminalApp apple-terminal
```

> **Default:** `terminalApp` = `apple-terminal` (Terminal.app). If you're on macOS and happy with Terminal.app, you can skip this step.
