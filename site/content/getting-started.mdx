...
4. `aigon server` — web UI at localhost:4100 showing pipeline, agent status, sessions. The **Reports tab** tracks token usage, cost, and throughput across agents — check it after your first feature to see telemetry in action
