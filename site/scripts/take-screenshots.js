...
const TARGETS = [
  ...
  // Insights tab (Pro) — may fail if Pro is not available
  {
    name: 'aigon-insights-metrics.png',
    url: `${DASHBOARD_URL}`,
    tab: 'insights',
    waitFor: '#insights-view',
    description: 'Quality metrics leaderboard',
    requiresPro: true,
  },
  {
    name: 'aigon-insights-charts.png',
    url: `${DASHBOARD_URL}`,
    tab: 'insights',
    waitFor: 'canvas',
  ...
  {
    name: 'aigon-insights-coaching.png',
    url: `${DASHBOARD_URL}`,
    tab: 'insights',
