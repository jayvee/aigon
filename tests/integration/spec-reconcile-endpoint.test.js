...
testAsync('POST /api/spec-reconcile refuses paths outside docs/specs without mutating', async () => {
    await withTempDirAsync('aigon-spec-reconcile-', async (repo) => {
        ...
        try {
            ...
            assert.strictEqual(response.body.skipped, 'expected-path-outside-docs');
