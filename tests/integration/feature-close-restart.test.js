...
const mk = (d, o = {}) => { const c = { n: 0 }; return { c, x: { runGit: () => d, getServerRegistryEntry: () => o.noServer ? null : { pid: 1 }, isProcessAlive: () => true, loadProjectConfig: () => o.cfg || {}, restartServer: () => { c.n++; }, log: () => {}, warn: () => {} } }; };
