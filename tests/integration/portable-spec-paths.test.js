...
// REGRESSION: portable spec paths must store repo-relative docs/specs references.
testAsync('toPortableSpecPath stores repo-relative docs/specs paths', async () => {
...
// REGRESSION: foreign absolute paths must resolve via docs/specs suffix on the local clone.
testAsync('resolvePortableSpecPath rebuilds foreign absolute paths from docs/specs suffix', async () => {
...
// REGRESSION: move_spec must follow foreign absolute fromPath on another clone layout.
testAsync('runFeatureEffect move_spec follows foreign absolute fromPath on another clone layout', async () => {
