...
const CASES = [
    ...
    // --- Rule 4: completion-signal handoff ---
    ['4', 'pendingCompletionSignal w/ !isWorking → Finalising implementation',
        {}, { currentSpecState: 'ready' },
        [{ id: 'cc', status: 'ready', isWorking: false, pendingCompletionSignal: 'implementation-complete' }],
        null, 'in-progress', null,
        { verb: 'Finalising implementation', tone: 'running', owner: 'cc' }],
    ...
    // --- Rule 9: drive/solo ---
    ['9', 'drive implementing → Implementing with elapsed implementation time',
        { startupReadiness: { startedAt: isoMinusSec(90) } }, { currentSpecState: 'implementing' },
        [{ id: 'solo', status: 'implementing', isWorking: true }], null, 'in-progress', null,
        { verb: 'Implementing', subject: null, tone: 'running', age: 90, ageLabel: 'Implementation running for' }],
    ['9', 'drive implementing omits elapsed time when feature start is unknown',
        {}, { currentSpecState: 'implementing' },
        [{ id: 'solo', status: 'implementing', isWorking: true, updatedAt: isoMinusSec(12) }], null, 'in-progress', null,
        { verb: 'Implementing', age: null, ageLabel: null }],
    ['9', 'drive ready → ready / Implemented',
        {}, { currentSpecState: 'ready' },
        [{ id: 'solo', status: 'ready', isWorking: false }], null, 'in-progress', null,
        { verb: 'Implemented', tone: 'ready', detail: null }],
    ['9', 'drive addressing review → active revision status',
        {}, { currentSpecState: 'code_revision_in_progress' },
        [{ id: 'cc', status: 'addressing-code-review', isWorking: true }], null, 'in-progress', null,
        { verb: 'Addressing review', tone: 'running' }],
    ['9', 'drive revision complete → completed revision without redundant context',
        {}, { currentSpecState: 'ready' },
        [{ id: 'cc', status: 'revision-complete', isWorking: false }], null, 'in-progress', null,
        { verb: 'Revision complete', tone: 'ready', detail: null }],
    ['9', 'recently ended implementation session uses the stable finalisation handoff',
        {}, { currentSpecState: 'implementing' },
        [{ id: 'cc', status: 'implementing', isWorking: false, flags: { sessionEnded: true, sessionEndedAt: isoMinusSec(5) } }], null, 'in-progress', null,
        { verb: 'Finalising implementation', tone: 'running', detail: null }],
    ['9', 'stale ended implementation session requests confirmation',
        {}, { currentSpecState: 'implementing' },
        [{ id: 'cc', status: 'implementing', isWorking: false, flags: { sessionEnded: true } }], null, 'in-progress', null,
        { verb: 'Implementation needs confirmation', tone: 'attention', detail: 'confirm to proceed' }],
