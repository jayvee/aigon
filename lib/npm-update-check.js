...
const REGISTRY_URL = 'https://registry.npmjs.org/@senlabsai/aigon';
...
async function checkForUpdate({ force = false, unref = false } = {}) {
    ...
    try {
        ...
        const result = {
            ...
            latestStable: null,
            latestNext: null,
            upgradeCommand: 'npm update -g @senlabsai/aigon',
    ...
    const result = {
        ...
        latestStable,
        latestNext,
        upgradeCommand: `npm update -g @senlabsai/aigon@${upgradeTag}`,
        checkedAt: new Date().toISOString(),
        error: null,
    };
