...
const REGISTRY_URL = 'https://registry.npmjs.org/@aigon/cli';
...
function fetchRegistryData(timeout = 8000) {
...
async function checkForUpdate({ force = false } = {}) {
    ...
    try {
        ...
        const result = {
            ...
            latestStable: null,
            latestNext: null,
            upgradeCommand: 'npm update -g @aigon/cli',
    ...
    const result = {
        ...
        latestStable,
        latestNext,
        upgradeCommand: `npm update -g @aigon/cli@${upgradeTag}`,
        checkedAt: new Date().toISOString(),
        error: null,
    };
