...
function createAndPrioritiseFromTemplate(repoPath, template, featureName, currentWeek) {
    ...
    instanceFmLines.push(`recurring_week: ${currentWeek}`);
    ...
    // Body paths/commands use {{YYYY-WW}} (same as name_pattern); see docs site recurring-features
    instanceBody = renderPattern(instanceBody, currentWeek);
