...
const entitySessions = require('./entity-sessions');
...
module.exports = {
    ...
    enrichedSessions,
    entitySessions,
    getEnrichedSessions: enrichedSessions.getEnrichedSessions,
    parseEnrichedTmuxSessionsOutput: enrichedSessions.parseEnrichedTmuxSessionsOutput,
};
