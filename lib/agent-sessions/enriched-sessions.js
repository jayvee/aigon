...
// Stage-dir names come from the sanctioned workflow-core constants leaf — the
// F554 boundary excludes engine/session behaviour, not path constants.
const { STAGE_FOLDERS: STAGE_DIRS } = require('../workflow-core/paths');
