...
// transitions now go through workflow-core engine (research-engine.js / engine.js)
...
function entityCloseFinalize(def, closeResult, ctx) {
    ...
    if (postFound) {
        const moved = u.moveFile(postFound, doneFolder, null, { actor: `cli/${def.prefix}-close` });
