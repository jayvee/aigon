...
function buildFeatureRecoverAction(snapshot, autonomousController, actions) {
...
function appendFeatureReviewRecoveryDashboardActions(repoPath, featureId, autoState, snapshot, validActions, autonomousController = null) {
    ...
    const recoverAction = buildFeatureRecoverAction(snapshot, autonomousController, tagged);
