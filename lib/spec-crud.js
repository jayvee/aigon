...
// parseFrontMatter and escapeRegex will move to lib/cli-parse.js in extraction 5;
// until then, import from utils.js.
function _parseFrontMatter(content) { return require('./utils').parseFrontMatter(content); }
function _escapeRegex(value) { return require('./utils').escapeRegex(value); }
