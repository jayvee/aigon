...
function createDashboardRouteDispatcher(serverCtx) {
    const routes = [
        ...
        // Second /api/sync/status registration (now removed) and the
        // /api/schedule/* routes moved to @aigon/pro with feature 236.
        {
            method: 'POST',
            path: '/api/doctor',
            handler(req, res, ctx) {
        ...
        // /api/schedule/jobs, /api/schedule/add, /api/schedule/cancel moved
        // to @aigon/pro with feature 236.
        {
            method: 'GET',
