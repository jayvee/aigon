    ...
    const routes = [
        {
            ...
            handler(req, res, ctx) {
                try {
                    ...
                    ctx.sendJson(200, data || { cc: null, cx: null });
                } catch (e) {
                    ctx.sendJson(200, { cc: null, cx: null });
                }
            }
        },
        {
        ...
        },
        {
            ...
            handler(req, res, ctx, match) {
                ...
                ctx.readJsonBody().then(payload => {
                    ...
                    if (workflowSlug) args.push(`--workflow=${workflowSlug}`);
        ...
        },
        {
            ...
            handler(req, res, ctx) {
                try {
                    ...
                    const status = ctx.routes.collectDashboardStatusData();
                    ctx.setLatestStatus(status);
                    ctx.sendJson(200, {
                        ok: true,
                        startedAt,
