...
const { filterEphemeralWorkingTreePaths } = require('./ephemeral-paths');
...
function warnUnrelatedWorkingTreeChanges(dirtyStatus, defaultBranch) {
    const paths = filterEphemeralWorkingTreePaths(parseGitStatusPaths(dirtyStatus));
...
function mergeFeatureBranch(target, {
    ...
    try {
        ...
        if (dirtyStatus) {
            warnUnrelatedWorkingTreeChanges(dirtyStatus, defaultBranch);
