...
function validateWorkflow(def) {
    ...
    if (counterReviewStages.length > 0 && stageAgentIds(counterReviewStages[0]).length !== 1) {
    ...
    if ((reviewStages.length > 0 || counterReviewStages.length > 0) && implementAgentCount !== 1) {
