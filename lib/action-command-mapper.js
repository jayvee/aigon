...
function formatActionCommand(action, entityId, options = {}) {
    ...
    switch (action) {
        ...
        case 'feature-review': return `aigon feature-code-review ${id}`;
        case 'feature-code-review': return `aigon feature-code-review ${id}`;
        case 'feature-code-revise': return `aigon feature-code-revise ${id}`;
        case 'feature-spec-review': return `aigon feature-spec-review ${entityId}`;
        case 'feature-spec-revise': return `aigon feature-spec-revise ${entityId}`;
        case 'feature-close': return `aigon feature-close ${id}${agentSuffix}`;
        case 'feature-resolve-and-close': return `aigon feature-open ${id}${agentSuffix}`;
        case 'feature-start': return `aigon feature-start ${id}`;
        case 'feature-autonomous-start': return `aigon feature-autonomous-start ${id}`;
        case 'feature-autonomous-resume': return `aigon feature-autonomous-resume ${id}`;
        case 'feature-autonomous-stop': return `aigon feature-autonomous-stop ${id}`;
        case 'feature-pause': return `aigon feature-pause ${id}`;
        case 'feature-resume': return `aigon feature-resume ${id}`;
        case 'feature-delete': return `aigon feature-delete ${id}`;
        ...
        case 'research-spec-revise': return `aigon research-spec-revise ${entityId}`;
        ...
        case 'agent-resume': return `aigon agent-resume ${id}${agentSuffix}`;
        case 'research-delete': return `aigon research-delete ${id}`;
        case 'feature-prioritise': return `aigon feature-prioritise ${entityId}`;
        case 'feature-unprioritise': return `aigon feature-unprioritise ${id}`;
        case 'research-prioritise': return `aigon research-prioritise ${entityId}`;
        case 'research-unprioritise': return `aigon research-unprioritise ${id}`;
