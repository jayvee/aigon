 ...
 *
 * The four operations are: draft, spec_review, implement, review.
 */

const agentRegistry = require('./agent-registry');
const statsAggregate = require('./stats-aggregate');

const OPERATIONS = ['draft', 'spec_review', 'implement', 'review'];
 ...
 *   notes            { draft?, spec_review?, implement?, review? }
 *   score            { draft?: number|null, spec_review?: number|null,
