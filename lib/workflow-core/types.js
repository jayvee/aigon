...
const ManualActionKind = Object.freeze({
  ...
  FEATURE_CODE_REVIEW_CHECK: 'feature-code-review-check',
  FEATURE_SPEC_REVIEW: 'feature-spec-review',
  FEATURE_SPEC_REVIEW_CHECK: 'feature-spec-review-check',
  ...
  RESEARCH_SPEC_REVIEW_CHECK: 'research-spec-review-check',
