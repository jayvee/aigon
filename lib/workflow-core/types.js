...
const LifecycleState = Object.freeze({
  ...
  CLOSING: 'closing',
  CLOSE_RECOVERY_IN_PROGRESS: 'close_recovery_in_progress',
  DONE: 'done',
  PAUSED: 'paused',
});
...
const ManualActionKind = Object.freeze({
  ...
  FEATURE_UNPRIORITISE: 'feature-unprioritise',
  ...
  FEATURE_CANCEL_CODE_REVIEW: 'feature-cancel-code-review',
  ...
  RESEARCH_CANCEL_CODE_REVIEW: 'research-cancel-code-review',
