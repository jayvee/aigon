...
function applyTransition(context, event) {
  ...
  switch (event.type) {
    ...
    case 'feature.spec_review.completed':
      sendIfAllowed({ type: 'feature.spec_review.completed', at: event.at });
      return {
        ...actor.getSnapshot().context,
        specReview: {
          ...(context.specReview || {}),
    ...
    case 'feature.spec_revision.completed':
      sendIfAllowed({ type: 'feature.spec_revision.completed', at: event.at });
      return {
        ...actor.getSnapshot().context,
        specReview: {
          ...(context.specReview || {}),
...
function applyResearchTransition(context, event) {
  ...
  switch (event.type) {
    ...
    case 'research.spec_review.completed':
      sendIfAllowed({ type: 'research.spec_review.completed', at: event.at });
      return {
        ...actor.getSnapshot().context,
        entityType: 'research',
        specReview: {
    ...
    case 'research.spec_revision.completed':
      sendIfAllowed({ type: 'research.spec_revision.completed', at: event.at });
      return {
        ...actor.getSnapshot().context,
        entityType: 'research',
        specReview: {
