...
function getResearchRoot(repoPath, researchId) {
  return getEntityRoot(repoPath, 'research', researchId);
}
...
function getResearchEventsPath(repoPath, researchId) {
  return getEventsPathForEntity(repoPath, 'research', researchId);
}
...
function getResearchSnapshotPath(repoPath, researchId) {
  return getSnapshotPathForEntity(repoPath, 'research', researchId);
}
...
function getResearchLockPath(repoPath, researchId) {
  return getLockPathForEntity(repoPath, 'research', researchId);
}
...
function getResearchSpecStateDir(repoPath, lifecycle) {
  return getSpecStateDirForEntity(repoPath, 'research', lifecycle);
}
...
function getResearchSpecPath(repoPath, researchId, lifecycle) {
