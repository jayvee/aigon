    ...
    const server = http.createServer((req, res) => {
        ...
        if (repoAgentDevServerPokeMatch && req.method === 'POST') {
            ...
            try {
                ...
                const worktreePath = agent.worktreePath || resolveFeatureWorktreePath(path.join(os.homedir(), '.aigon', 'worktrees', path.basename(repoPath)), featureId, agentId) || repoPath;
