...
const { countReviewableSetMembers } = require('./feature-set-spec-review');
...
function collectFeatures(repoContext, response) {
    ...
    specFiles.forEach(({ file: specFile, stage, dir: specDir }) => {
        ...
        features.push({
            ...
            authorAgentId: featureState.workflowSnapshot ? (featureState.workflowSnapshot.authorAgentId || Object.keys(featureState.workflowSnapshot.agents || {})[0] || null) : null,
            specPath,
...
function collectResearch(repoContext, response) {
    ...
    dedupedResearchSpecFiles.forEach(({ file, stage, dir: specDir }) => {
        ...
        research.push({
            ...
            authorAgentId: snapshot ? (snapshot.authorAgentId || Object.keys(snapshot.agents || {})[0] || null) : null,
