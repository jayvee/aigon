...
const NON_WORKING_AGENT_STATUSES = new Set([
    'submitted', 'implementation-complete', 'revision-complete', 'research-complete',
    'review-complete', 'spec-review-complete', 'waiting', 'addressing-review', 'feedback-addressed',
]);
