...
const DEFAULT_GLOBAL_CONFIG = {
    terminal: 'warp',  // Terminal emulator: 'warp', 'cmux', 'code', 'cursor', 'terminal', 'tmux'
...
function getProfilePlaceholders() {
    ...
    // Resolve instructions.testing directive (default: "full")
    const testingLevel = projectConfig?.instructions?.testing || 'full';
    const testingPlaceholders = resolveTestingPlaceholders(testingLevel, playwrightEnabled, playwrightContent);
