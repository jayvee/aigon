...
function getFeatureDashboardState(repoPath, featureId, currentStage, agents) {
    ...
    const snapshotActions = workflowSnapshotAdapter.snapshotToDashboardActions('feature', featureId, snapshot, currentStage);
...
function getResearchDashboardState(repoPath, researchId, currentStage, agents) {
    ...
    const snapshotActions = workflowSnapshotAdapter.snapshotToDashboardActions('research', researchId, snapshot, currentStage);
    return {
        workflowEngine: 'workflow-core',
        workflowSnapshot: snapshot,
        snapshotStatuses,
