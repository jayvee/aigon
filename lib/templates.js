...
const COMMAND_REGISTRY = {
    ...
    'feature-start': { aliases: ['afs'], argHints: '<ID> [agents...] [--workflow <slug>]' },
    ...
    'feature-autonomous-start': { argHints: '<feature-id> [agents...] [--workflow <slug>] [--eval-agent=<agent>] [--review-agent=<agent>] [--stop-after=implement|eval|review|close] | status <feature-id>' },
    'workflow': { argHints: '<create|list|show|delete> [...]', disableModelInvocation: true },
