...
const COMMAND_REGISTRY = {
    ...
    'feature-code-review-check': { aliases: ['afrc'], argHints: '[ID]' },
    'feature-review': { argHints: '<ID>' },
    'feature-review-check': { argHints: '[ID]' },
    'feature-spec-review': { aliases: ['afsr'], argHints: '<ID|slug> [--agent=<agent-id>]' },
    'feature-spec-review-check': { aliases: ['afsrc'], argHints: '<ID|slug> [--agent=<agent-id>]' },
    'feature-spec-review-record': { argHints: '<ID|slug>', disableModelInvocation: true },
    'feature-spec-review-check-record': { argHints: '<ID|slug>', disableModelInvocation: true },
    ...
    'research-spec-review-check': { aliases: ['arsrc'], argHints: '<ID|slug> [--agent=<agent-id>]' },
    'research-spec-review-record': { argHints: '<ID|slug>', disableModelInvocation: true },
    'research-spec-review-check-record': { argHints: '<ID|slug>', disableModelInvocation: true },
