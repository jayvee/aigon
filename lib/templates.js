...
const COMMAND_REGISTRY = {
    ...
    'feature-do': { aliases: ['afd'], argHints: '<ID> [--agent=<cc|gg|cx|cu>] [--iterate] [--max-iterations=N] [--auto-submit] [--no-auto-submit] [--dry-run]' },
    ...
    'feature-spec-review': { aliases: ['afsr'], argHints: '<ID|slug> [--agent=<cc|gg|cx|cu>]' },
    'feature-spec-review-check': { aliases: ['afsrc'], argHints: '<ID|slug> [--agent=<cc|gg|cx|cu>]' },
    ...
    'research-spec-review': { aliases: ['arsr'], argHints: '<ID|slug> [--agent=<cc|gg|cx|cu>]' },
    'research-spec-review-check': { aliases: ['arsrc'], argHints: '<ID|slug> [--agent=<cc|gg|cx|cu>]' },
