...
const COMMAND_REGISTRY = {
    ...
    'agent-status': { argHints: '<implementing|waiting|ready|error|awaiting-input|implementation-complete|revision-complete|review-complete|research-complete|spec-review-complete>', disableModelInvocation: true },
