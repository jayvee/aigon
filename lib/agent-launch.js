 ...
 */
function resolveLaunchTriplet({ agentId, snapshot, stageDefaultModel, launcherModel, launcherEffort }) {
 ...
 */
function buildAgentLaunchInvocation({ agentId, snapshot, stageDefaultModel, launcherModel, launcherEffort }) {
