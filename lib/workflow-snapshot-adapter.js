...
const LIFECYCLE_TO_STAGE = Object.freeze(Object.fromEntries(
  Object.entries(FEATURE_INTERACTION_DEFINITION.stateMeta).map(([state, metadata]) => [state, metadata.lane])
));
...
function mapSnapshotActionToDashboard(entityType, entityId, action) {
  ...
  return {
    ...
    recommendedOrder: action.recommendedOrder,
