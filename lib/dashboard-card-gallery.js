...
function buildSetCurrentFeatureContract(options) {
    ...
    const plan = manual ? null : autonomousPlan('implement', failed ? 'failed' : (running ? 'running' : 'stopped'));
    return buildFeatureUiContract({
        ...
        cardHeadline: {
            verb: failed ? 'Implementation failed' : (running ? 'Implementing' : 'Implementation complete'),
