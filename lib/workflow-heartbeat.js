...
function getHeartbeatConfig(projectConfig) {
  ...
  return {
    ...
    timeoutMs: Number(process.env.AIGON_HEARTBEAT_TIMEOUT_MS) || hbConfig.timeoutMs || wfConfig.heartbeatTimeoutMs || DEFAULT_HEARTBEAT_TIMEOUT_MS,
    deadMs: Number(process.env.AIGON_HEARTBEAT_DEAD_MS) || hbConfig.deadMs || DEFAULT_HEARTBEAT_DEAD_MS,
  };
}
