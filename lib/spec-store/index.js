 ...
 * the git-branch backend stores canonical events on an orphan branch with a local
...
/**
 * @param {{ repoPath: string, backend?: 'local'|'git-branch', storage?: ReturnType<typeof resolveStorageConfig> }} options
