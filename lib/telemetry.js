...
function aggregateNormalizedTelemetryRecords(featureId, agent, options = {}) {
    ...
    for (const file of files) {
        ...
        // Time-window filter: only include records that started after afterMs.
        // Prevents cross-run accumulation (e.g. 23 prior benchmark sessions all
        // contributing to a single benchmark run's cost figure).
