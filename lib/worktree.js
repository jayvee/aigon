 ...
 * codex's broken `~/.codex/prompts/` discovery. We can't safely embed
 * that body in a shell command line — instead we write it to disk and
 * reference it via the bash `$(< file)` form.
 *
