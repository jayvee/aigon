 ...
 *
 * Supports both feature worktrees (uses cliConfig.implementPrompt with {featureId})
 * and research entities (uses CMD_PREFIX + slash command). Set wt.entityType = 'research'
 * to use the research command path.
 *
...
function buildAgentCommand(wt, taskType = 'implement') {
    ...
    let modelKey;
    if (isResearch) {
        // Research: use CMD_PREFIX + slash command
