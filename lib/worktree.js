...
function presetGeminiTrust(worktreePaths) {
    ...
    try {
        ...
        // Trust the parent worktrees directory only — covers all current and future worktrees.
        // Don't add individual worktree paths (they accumulate forever and never get cleaned up).
        let changed = false;
