...
function buildRawAgentCommand(wt, taskType = 'do') {
    ...
    if (isResearch) {
        ...
        if (normalizedTaskType === 'eval' || normalizedTaskType === 'review') {
            prompt += ' --no-launch';
            // In autonomous mode the eval agent auto-picks a winner and runs feature-close
            if (normalizedTaskType === 'eval' && wt.autonomous) prompt += ' --autonomous';
        }
