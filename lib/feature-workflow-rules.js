...
const FEATURE_ENGINE_GUARDS = Object.freeze({
    ...
    isSubmitted: 'Projected lifecycle is submitted.',
...
const FEATURE_ENGINE_STATES = Object.freeze({
    ...
    close_recovery_in_progress: [
        ...
        { event: 'feature.close_recovery.ended', to: 'submitted', guard: 'closeRecoveryReturnToSubmitted' },
        ...
        { event: 'feature.close_recovery.cancelled', to: 'submitted', guard: 'closeRecoveryReturnToSubmitted' },
        { event: 'feature.pause', to: 'paused' },
    ],
    code_revision_complete: [],
    evaluating: [
...
const FEATURE_ACTION_CANDIDATES = Object.freeze([
    ...
    },
    {
        ...
        guard: ({ context }) => {
            ...
            return agents.some(agent => agent.status === 'ready' || agent.status === 'submitted');
        },
        metadata: {
    ...
    },
    {
        ...
        modeFilter: 'solo',
        guard: ({ context }) => {
            if (['implementing', 'submitted'].includes(context.currentSpecState)) return true;
