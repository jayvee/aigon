 ...
 *
 * The manifest is the single source of truth for state. If the manifest
 * disagrees with the spec folder, that's a problem for `doctor --fix`
 * to resolve explicitly — NOT something to silently rewrite on every read.
 *
