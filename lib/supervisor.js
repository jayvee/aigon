 ...
 *   2. If the tmux session exists or the heartbeat file is fresh -> emit signal.heartbeat
 *      (engine dedupes via isSignalRedundant).
 *   3. If both session is gone and heartbeat is stale -> emit signal.heartbeat_expired
