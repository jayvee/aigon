...
function handleList(options) {
    ...
    const header = ['SLUG', 'MEMBERS', 'DONE', 'BACKLOG', 'IN-PROGRESS', 'LAST UPDATED'];
    const rows = [header];
...
function printHelp() {
    ...
    console.log('Set state is derived from member workflow state — no new files are written.');
}
