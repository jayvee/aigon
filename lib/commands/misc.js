        ...
        'agent-status': async (args) => {
            ...
            if (hasWorkflowState) {
                ...
                if (status === 'implementing') {
                    ...
                    wf.recordCodeRevisionCompleted(mainRepo, entityType, featureNum, {
                        revisionAgentId: agentId,
                        source: 'agent-status/feedback-addressed',
                    }).catch((err) => {
                        console.error(`⚠️  Engine code revision completion failed: ${err.message}`);
                    });
                }
            }
