            ...
            if (subcommand === 'create') {
                ...
                let draft = {
                    ...
                    version: getOptionValue(options, 'version')
                        ...
                        : undefined,
                    stages: parseWorkflowStageFlags(getOptionValues(options, 'stage')),
                ...
                if (draft.stages.length > 0 && draft.version === undefined) {
                    draft.version = 2;
                }

                const needsInteractive = draft.agents.length === 0 && draft.stages.length === 0;
