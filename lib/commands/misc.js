    ...
    return {
        ...
        'workflow': async (args) => {
            ...
            if (subcommand === 'create') {
                ...
                const needsInteractive = draft.agents.length === 0
                    || !draft.label
                    || draft.stopAfter === null
                    || (draft.agents.length > 1 && !draft.evalAgent)
                    || (draft.agents.length === 1 && draft.reviewAgent === null && !Object.prototype.hasOwnProperty.call(options, 'review-agent'));
