...
Options:
  ...
  --ignore-staleness     Re-run pairs even if benchmarked within the last 30 days
  --skip-probe           Skip the fast PONG probe gate before each run
            ...
            if (flags.has('--all')) {
                ...
                try {
                    await perfBench.runAllBenchmarks({
                        ...
                        repoPath: process.cwd(),
                        skipBaseline: true,
                        skipProbe: flags.has('--skip-probe'),
                        ignoreStaleness: flags.has('--ignore-staleness'),
                        timeoutMs,
                        dryRun,
