...
const { buildActionContext, assertActionAllowed, runDelegatedAigonCommand, withActionDelegate } = require('../action-scope');
...
const { parseCliOptions, getOptionValue, parseFrontMatter, serializeYamlScalar, slugify } = require('../cli-parse');
...
module.exports = function featureCommands(ctx) {
    ...
    const handlerDeps = {
        ...
        runAigonCliCommand,
        persistFeatureAutoState,
        readPersistedFeatureAutoState,
        findAutoSessionNameByFeatureId,
