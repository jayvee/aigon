                        ...
                        if (reviewStarted && effectiveStopAfter === 'close' && !closeTriggered && !feedbackInjected) {
                            ...
                            if (reviewCompleted) {
                                ...
                                if (tmuxSessionExists(implSessionName)) {
                                    const feedbackPrompt = 'The review is complete. Please run /aigon:feature-review-check to check and address the review feedback, then submit your changes with /aigon:feature-submit';
