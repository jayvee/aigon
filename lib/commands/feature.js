...
`;
        ...
        'feature-autonomous-start': async (args) => {
            ...
            // Pro gate: only the user-facing start path. __run-loop, status, stop
            // are dispatched above and never reach here. Defensive exemption in case
            // a future "stop" subcommand is added below this point.
            if (subcommand !== 'stop') {
