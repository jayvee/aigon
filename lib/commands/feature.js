...
module.exports = function featureCommands(ctx) {
    ...
    const cmds = {
        ...
        'feature-create': (args) => {
            ...
            const built = entity.entityCreate(entity.FEATURE_DEF, name, ctx, { description, set: setSlug || null });
        ...
        'feature-code-revise': (args) => {
            ...
            writeAgentStatus(id, implAgent, { status: 'addressing-review' });
