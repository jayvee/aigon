...
`;
        ...
        'feature-autonomous-start': async (args) => {
            ...
            if (subcommand === '__run-loop') {
                ...
                let feedbackInjectionTime = null;
                let feedbackPolls = 0;
                ...
                while (true) {
                    ...
                    if (!isFleet) {
                        ...
                        if (reviewStarted && effectiveStopAfter === 'close' && !closeTriggered && !feedbackInjected) {
                            ...
                            if (reviewCompleted) {
                                ...
                                if (tmuxSessionExists(implSessionName)) {
                                    ...
                                    const submitCommand = `${cmdPrefix}feature-submit`;
                                    const feedbackPrompt = `The review is complete. Please run ${reviewCheckCommand} to check and address the review feedback, then submit your changes with ${submitCommand}`;
                                    ...
                                    feedbackInjectionTime = new Date().toISOString();
                                } else {
                        ...
                        if (feedbackInjected && !feedbackAddressed && !closeTriggered) {
                            ...
                            const implUpdatedAt = implStatus && implStatus.updatedAt ? implStatus.updatedAt : null;
                            const resubmitted = implUpdatedAt && feedbackInjectionTime && implUpdatedAt > feedbackInjectionTime;
                            console.log(`  [feedback ${feedbackPolls}/${MAX_FEEDBACK_POLLS}] implSession running=${implSessionRunning} implUpdatedAt=${implUpdatedAt} resubmitted=${resubmitted}`);
