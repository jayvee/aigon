...
module.exports = function featureCommands(ctx) {
    ...
    return {
        ...
        'feature-setup': (args) => {
            ...
            // Outbox replay check: if a previous feature-setup was interrupted, resume
            ...
            if (!isSetupReplay) {
                try {
                    ctx.stateMachine.requestTransition(featureId, 'feature-setup', {
                        agents: agentIds,
                        actor: 'cli/feature-setup',
                    });
                } catch (e) {
                ...
                console.log(`📋 Resuming interrupted feature-setup (${existingM.pending.length} ops remaining)...`);
            }
            ...
            if (found) {
                moveFile(found, '03-in-progress', null, { actor: 'cli/feature-setup' });
...
`;
        ...
        'feature-autopilot': (args) => {
            ...
            if (existingWorktrees.length > 0) {
                ...
                selfCommands['feature-setup']([featureId, ...agentIds]);
...
function createFeatureCommands(overrides = {}) {
    ...
    const names = [
        'feature-create', 'feature-prioritise', 'feature-now', 'feature-setup',
