...
module.exports = function featureCommands(ctx) {
    ...
    const cmds = {
        ...
        'feature-prioritise': (args) => {
            ...
            moveFile(found, '02-backlog', newName, { actor: 'cli/feature-prioritise' });
            ...
            // Create the manifest explicitly so feature-start doesn't need to bootstrap
            manifest.ensureManifest(paddedId);
