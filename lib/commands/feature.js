...
`;
        ...
        'feature-close': async (args) => {
            ...
            // Commit the moved spec and log files
            {
                ...
                // Force-move spec to 05-done if it's not there yet.
                // The engine effect uses fs.rename but the merge brings the old location back.
                // This is the authoritative move — don't trust the engine effect for this.
                ...
                try {
                    ...
                    // May fail if no changes to commit — that's fine
                }
            }
