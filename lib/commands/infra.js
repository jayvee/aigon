    ...
    const commands = {
        ...
        'dashboard': async (args) => {
            ...
            if (isPreview) {
                ...
                const templateDir = path.join(process.cwd(), 'templates', 'dashboard');
            ...
            if (!sub || sub === 'start') {
                ...
                const serverOptions = isPreview ? { templateRoot: process.cwd() } : undefined;
            ...
            if (sub === 'restart') {
                ...
                const restartOptions = isPreview ? { templateRoot: process.cwd() } : undefined;
