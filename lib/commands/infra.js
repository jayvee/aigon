...
<dict>
    ...
    return { ...commands, ...require('./storage')(ctx), ...require('./spec-layout')(ctx) };
};
...
function createInfraCommands(overrides = {}) {
    ...
    const names = ['dashboard', 'server', 'preview', 'terminal-focus', 'board', 'proxy-setup', 'proxy', 'dev-server', 'config', 'hooks', 'profile', 'sync', 'backup', 'storage', 'spec-layout'];
