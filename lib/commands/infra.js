...
<dict>
    ...
    return { ...commands, ...require('./storage')(ctx) };
};
...
function createInfraCommands(overrides = {}) {
    ...
    const names = ['dashboard', 'server', 'preview', 'terminal-focus', 'board', 'proxy-setup', 'proxy', 'dev-server', 'config', 'hooks', 'profile', 'sync', 'backup', 'storage'];
