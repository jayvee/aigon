...
module.exports = function infraCommands(ctx) {
    ...
    const commands = {
        ...
        // 'dashboard' command removed — use 'aigon server' instead.
        // Preview dashboard for worktree development is available via 'aigon server start --preview'.
        'dashboard': async (args) => {
            console.log('ℹ️  "aigon dashboard" has been renamed to "aigon server".');
            console.log('   Run: aigon server ' + (args.length ? args.join(' ') : '--help'));
        },
