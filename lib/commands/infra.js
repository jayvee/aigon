    ...
    <string>${logPath}</string>
        ...
        'server': async (args) => {
            ...
            const buildLaunchParams = (extra = {}) => {
                ...
                defaultRepoPath: previewMode ? mainRepo : undefined,
                appId: SERVER_APP_ID,
                proxyAvailable: !identity.isEphemeral && isProxyAvailable(),
                ...extra,
            };
            };
        ...
        'preview': async (args) => {
            ...
            if (!featureId) {
                console.error('Usage: aigon preview <feature-id> [--stop] [--agent=<id>] [--open]');
                console.error('');
            ...
            if (options.stop === true) {
                ...
                if (stopped) {
                    console.log(`✅ Preview stopped for feature #${featureId} (${worktree.agent}).`);
                } else {
            ...
            try {
                const result = await startPreviewForWorktree(worktree.path, { isProcessAlive });
