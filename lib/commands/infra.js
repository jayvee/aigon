...
module.exports = function infraCommands(ctx) {
    ...
    const commands = {
        ...
        'proxy-setup': () => {
            console.log('ℹ️  proxy-setup is not implemented as a CLI command.');
            console.log('   See docs/development_workflow.md for proxy configuration instructions.');
        },
...
function createInfraCommands(overrides = {}) {
    ...
    const names = ['conductor', 'dashboard', 'terminal-focus', 'board', 'proxy-setup', 'dev-server', 'config', 'hooks', 'profile'];
