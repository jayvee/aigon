        ...
        'config': (args) => {
            ...
            if (subcommand === 'init') {
                ...
                if (scope === 'global') {
                    ...
                    console.log(`\n   You can customize:`);
                    console.log(`   - terminalApp: Terminal app for tmux sessions (warp, iterm2, apple-terminal)`);
                    ...
                    console.log(`   {`);
                    console.log(`     "terminalApp": "warp",          // warp, iterm2, apple-terminal`);
                    console.log(`     "agents": {`);
        ...
        'server': async (args) => {
            ...
            if (sub === 'status') {
                ...
                if (healthResult && healthResult.body) {
                    if (healthOk) console.log(`  Health: ok (${healthResult.body.repoCount || 0} repos)`);
                    else console.log(`  Health: failed${healthResult.body.error ? ` — ${healthResult.body.error}` : ''}`);
                } else {
