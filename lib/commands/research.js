    ...
    return {
        ...
        'research-do': (args) => {
            ...
            if (isFleetMode) {
                ...
                console.log(`\n   Hard rules — your findings are NOT submitted until the status command exits 0:`);
                ...
                console.log(`   - Submitting your signal has nothing to do with research-eval — that is a separate user step`);
                console.log(`\n⚠️  IMPORTANT:`);
