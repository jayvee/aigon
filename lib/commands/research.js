    ...
    return {
        ...
        'research-setup': (args) => {
            ...
            if (found.folder === '02-backlog') {
                found = moveFile(found, '03-in-progress', null, { actor: 'cli/research-setup' });
            } else {
        ...
        'research-autopilot': (args) => {
            ...
            // Get reference to self for calling research-setup
            ...
            if (existingFindings.length === 0) {
                ...
                selfCommands['research-setup']([researchId, ...agentIds]);
            } else {
...
function createResearchCommands(overrides = {}) {
    ...
    const names = [
        'research-create', 'research-prioritise', 'research-setup', 'research-open',
