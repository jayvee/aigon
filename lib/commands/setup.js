    ...
    const commands = {
        ...
        'check-version': async (args = []) => {
            ...
            if (!installedVersion || compareVersions(currentVersion, installedVersion) !== 0) {
                ...
                console.log(`🔄 Project sync needed (project: ${from}, CLI: ${currentVersion}). Run \`aigon apply\` to sync.`);
            } else {
                ...
                if (configChanged) {
                    console.log(`🔄 Config change detected. Run \`aigon apply\` to apply.`);
                } else if (behind === 0) {
                    try {
        ...
        'apply': async (args = []) => {
            ...
            try {
                ...
                // Only stage paths updated by this `update` run (aigon-managed artifacts).
