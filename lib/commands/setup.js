...
module.exports = function setupCommands(ctx) {
    ...
    const commands = {
        ...
        'doctor': (args) => {
            ...
            // Agent CLI checks
            const agentBinMap = { cc: 'claude', gg: 'gemini', cx: 'codex', cu: 'cursor' };
            ...
            if (process.platform === 'linux') {
                ...
                try {
                    ...
                    console.log('  ❌ tmux is not installed — required for agent sessions');
                    console.log('     Install: sudo apt install tmux  (or yum/pacman equivalent)');
                }
