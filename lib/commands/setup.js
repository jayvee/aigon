        ...
        'seed-reset': async (args) => {
            ...
            async function provisionPhase() {
                ...
                try {
                    ...
                    //     Maintainer-only: gated on workingRepoUrl so end users don't try to push
                    //     to a seed they don't own. Skipped in bench mode (seed doesn't change between pairs).
                    if (workingRepoUrl && !benchMode) {
                        try {
