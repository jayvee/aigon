...
function createSetupCommands(overrides = {}) {
    ...
    const names = ['init', 'install-agent', 'onboarding', 'global-setup', 'check-prerequisites', 'check-version', 'update', 'project-context', 'doctor', 'seed-reset', 'trust-worktree'];
