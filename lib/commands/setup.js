    ...
    const commands = {
                ...
                try {
                    ...
                    if (gitStatus) {
                        ...
                        if (args.includes('--commit')) {
                            try {
                                execSync(`git add docs/ AGENTS.md .claude/ .cursor/ .codex/ .gemini/ 2>/dev/null; git commit -m "${commitMsg}"`, { stdio: 'pipe' });
                            ...
                            console.log(`   git add docs/ AGENTS.md .claude/ .cursor/ .codex/ .gemini/ 2>/dev/null; git commit -m "${commitMsg}"`);
                        }
                    }
                } catch (e) {
        ...
        'seed-reset': (args) => {
            ...
            if (installedAgents.length > 0) {
                ...
                // Untrack .aigon/version if it was previously committed
                try {
                    execSync('git rm --cached .aigon/version 2>/dev/null', { cwd: repoPath, stdio: 'pipe' });
                } catch (e) { /* not tracked, fine */ }
