                        ...
                        for (const outputSpec of config.outputs) {
                            ...
                            commandNames.forEach(cmdName => {
                                ...
                                if (isSkillMd) {
                                    ...
                                    if (status !== 'unchanged') {
                                        installManifestLib.recordFile(installManifest, skillFilePath, repoRoot, aigonVersion);
                                    }
                                ...
                                if (status !== 'unchanged') {
                                    installManifestLib.recordFile(installManifest, cmdFilePath, repoRoot, aigonVersion);
                                }
                                ...
                                aliases.forEach(alias => {
                                    ...
                                    if (aliasStatus !== 'unchanged') {
                                        installManifestLib.recordFile(installManifest, aliasFilePath, repoRoot, aigonVersion);
                                    }
                                });
                            });
...
function createSetupCommands(overrides = {}) {
    ...
    const names = ['init', 'install-agent', 'uninstall', 'setup', 'global-setup', 'check-prerequisites', 'check-version', 'apply', 'update', 'project-context', 'doctor', 'seed-reset', 'trust-worktree'];
