...
//   agent-signals.js, ops.js, insights.js — misc command split (F636)
// ─────────────────────────────────────────────────────────────────────────────
...
const { createAgentLaunchCommands } = require('./agent-launch');
const { createSignalHealthCommands } = require('./signal-health');
