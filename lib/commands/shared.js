        ...
        if (subcommand === 'start') {
            ...
            if (!registerOnly) {
                ...
                if (useProxy) {
                    ...
                    console.log(`   URL:  ${url}`);
                    console.log(`   Port: ${port}  PID: ${pid}`);
                    const reason = proxyUnavailableReason();
                    if (reason) {
                        console.log(`\n   ⚠️  Proxy: ${reason}`);
