...
- **Implementation Log**: `./docs/specs/features/logs/feature-NN-cu-log.md`
...
4. **Complete properly**: Use `/aigon-feature-close <ID>` for Drive, `/aigon-feature-close <ID> cu` for Fleet
