...
- [ ] Write a benchmark report to `docs/reports/agent-matrix-benchmark-{{YYYY-WW}}.md` with sections: Agent/Model, Task, Outcome (pass/fail), TypeScript clean (yes/no), Approach summary (2–3 sentences), Notable issues
