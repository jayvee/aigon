...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-06-17T23:41:58.103Z", actor: "cli/feature-prioritise" }
---

# Feature: Bump ws to 8.21.0 — fix HIGH DoS advisory
...
Upgrade direct runtime dependency ws from ^8.20.0 to >=8.21.0 to resolve HIGH severity memory exhaustion DoS (GHSA-96hv-2xvq-fx4p) and moderate memory disclosure (GHSA-58qx-3vcg-4xpx). npm audit fix --omit=dev confirms single-package bump. Filed by dependency-triage-2026-W25 (feature 558). --agent cu
