...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-11T03:23:56.193Z", actor: "recurring/feature-prioritise" }
---
...
Run the weekly dependency and package-supply-chain triage for the Aigon repo. Capture the current dependency-security signals, write a concise report to `.aigon/reports/dependency-triage-2026-W28.md`, and create + prioritise follow-up features only when the findings require code or dependency changes.
...
- [ ] Write `.aigon/reports/dependency-triage-2026-W28.md` with a concise summary of actionable findings and raw command outcomes
...
4. Write `.aigon/reports/dependency-triage-2026-W28.md` with:
   - headline summary
   - actionable findings
