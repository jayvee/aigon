...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-05-27T23:28:51.384Z", actor: "cli/feature-prioritise" }
---
...
- [ ] **Get started section**: install command + doc links grid, restyled
- [ ] **Pro CTA section**: restyled to match Swiss Light, keep existing content pointing to /pro
