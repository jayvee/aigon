...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-01T01:23:40.026Z", actor: "recurring/feature-prioritise" }
---
...
- [ ] Commit all doc changes: `git add AGENTS.md docs/architecture.md docs/development_workflow.md site/content/ && git commit -m "docs: automated gap fixes 2026-W27"`
...
11. `git add AGENTS.md docs/architecture.md docs/development_workflow.md site/content/ && git commit -m "docs: automated gap fixes 2026-W27"`
