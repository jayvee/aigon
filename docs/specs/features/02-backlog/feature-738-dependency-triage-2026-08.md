...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-08-01T23:26:22.092Z", actor: "recurring/feature-prioritise" }
---

# dependency-triage-2026-08

## Summary

Run the weekly dependency and package-supply-chain triage for the Aigon repo. Capture the current dependency-security signals, write a concise report to `.aigon/reports/dependency-triage-2026-W31.md`, and create + prioritise follow-up features only when the findings require code or dependency changes.
...
- [ ] Write `.aigon/reports/dependency-triage-2026-W31.md` with a concise summary of actionable findings and raw command outcomes
...
4. Write `.aigon/reports/dependency-triage-2026-W31.md` with:
   - headline summary
   - actionable findings
