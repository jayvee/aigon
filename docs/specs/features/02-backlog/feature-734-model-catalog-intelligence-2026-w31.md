...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-26T23:21:37.159Z", actor: "recurring/feature-prioritise" }
---

# model-catalog-intelligence-2026-W31
...
- [ ] Commit the applied changes as `chore(models): refresh op catalog 2026-W31`.
...
- [ ] Write `.aigon/reports/model-catalog-intelligence-2026-W31.md` using the template below.
...
Write to `.aigon/reports/model-catalog-intelligence-2026-W31.md`:
...
- [ ] `chore(models): refresh op catalog 2026-W31` — only if patches approved
...
- Write `.aigon/reports/model-catalog-intelligence-2026-W31.md`.
