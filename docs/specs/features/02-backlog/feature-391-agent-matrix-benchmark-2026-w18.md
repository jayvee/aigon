...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-04-26T14:13:22.051Z", actor: "recurring/feature-prioritise" }
---

# agent-matrix-benchmark-2026-W18
...
- [ ] Write a benchmark report to `docs/reports/agent-matrix-benchmark-2026-W18.md` with sections: Agent/Model, Task, Outcome (pass/fail), TypeScript clean (yes/no), Approach summary (2–3 sentences), Notable issues
- [ ] Commit the report: `git add docs/reports/ && git commit -m "chore: agent-matrix benchmark 2026-W18"`
...
4. Write the benchmark report to `docs/reports/agent-matrix-benchmark-2026-W18.md` (in the aigon repo, not brewboard).
