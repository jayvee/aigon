...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-01T01:23:40.188Z", actor: "recurring/feature-prioritise" }
---
...
- [ ] Write `.aigon/matrix-refresh/2026-07-01/proposed.json` with the structured patch (see format below)
...
- The patch file path: `.aigon/matrix-refresh/2026-07-01/proposed.json`
