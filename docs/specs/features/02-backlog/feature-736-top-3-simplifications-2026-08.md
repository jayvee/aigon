...
- [ ] Write `.aigon/reports/simplifications-2026-08.md` using the report template below
- [ ] For **each** of the three picks, run `aigon feature-create "<short-kebab-name>" --description "<one-sentence summary; see report section N for full rationale>"`. Use a name like `simplify-<area>-2026-08` so the inbox stays tidy
- [ ] Commit the three new spec files: `git add docs/specs/features/01-inbox/ && git commit -m "chore: top-3 simplifications inbox specs 2026-08"` — report is gitignored
...
```sh
aigon feature-create "simplify-<short-area>-2026-08" --description "<one-sentence summary>. See .aigon/reports/simplifications-2026-08.md § <section> for scoring and proposed change."
```
...
Write the report to `.aigon/reports/simplifications-2026-08.md`:
...
**Inbox feature:** `simplify-<area>-2026-08` (filed via `feature-create`)
...
- Write to `.aigon/reports/simplifications-2026-08.md` and run `aigon feature-create` up to 3 times.
- Commit with message `chore: top-3 simplifications inbox specs 2026-08` (report is gitignored, do not add it).
