...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-25T13:13:42.794Z", actor: "recurring/feature-prioritise" }
---

# stale-entity-sweep-2026-W30

## Summary

Scan inbox and backlog specs for features and research topics that have been sitting untouched for more than 3 weeks. Scan in-progress features for those with no commits in the last 7 days. Write a triage report to `.aigon/reports/stale-entities-2026-W30.md`. Close without evaluation when complete.
...
- [ ] Write findings to `.aigon/reports/stale-entities-2026-W30.md` with:
...
- [ ] Close the feature (no eval step needed) — report is gitignored
...
4. Write `.aigon/reports/stale-entities-2026-W30.md`
