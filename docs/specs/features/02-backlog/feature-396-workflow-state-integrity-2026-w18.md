...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-04-26T14:13:22.910Z", actor: "recurring/feature-prioritise" }
---

# workflow-state-integrity-2026-W18

## Summary

Run `aigon doctor` across all registered repos and write a state-health report to `docs/reports/workflow-state-2026-W18.md`. Surface snapshotless inbox entities, slug/numeric mismatches, and port conflicts without applying fixes. Close without evaluation when complete.
...
- [ ] Write findings to `docs/reports/workflow-state-2026-W18.md` with:
...
4. Write `docs/reports/workflow-state-2026-W18.md`
5. `git add docs/reports/ && git commit -m "chore: workflow state integrity report 2026-W18"`
