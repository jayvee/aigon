...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-05-17T23:14:11.515Z", actor: "recurring/feature-prioritise" }
---
...
Run `npm audit` and `npm outdated` and write the findings to `.aigon/reports/dep-sweep-2026-W21.md`. Close without evaluation when complete.

## Acceptance Criteria

- [ ] Run `npm audit --json` and capture the output
- [ ] Run `npm outdated` and capture the output
- [ ] Write findings to `.aigon/reports/dep-sweep-2026-W21.md` with sections for audit results and outdated packages
...
3. Write `.aigon/reports/dep-sweep-2026-W21.md` with:
