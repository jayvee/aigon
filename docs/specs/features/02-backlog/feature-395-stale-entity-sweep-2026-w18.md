...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-04-26T14:13:22.725Z", actor: "recurring/feature-prioritise" }
---

# stale-entity-sweep-2026-W18

## Summary

Scan inbox and backlog specs for features and research topics that have been sitting untouched for more than 3 weeks. Scan in-progress features for those with no commits in the last 7 days. Write a triage report to `docs/reports/stale-entities-2026-W18.md`. Close without evaluation when complete.
...
- [ ] Write findings to `docs/reports/stale-entities-2026-W18.md` with:
...
4. Write `docs/reports/stale-entities-2026-W18.md`
5. `git add docs/reports/ && git commit -m "chore: stale entity sweep 2026-W18"`
