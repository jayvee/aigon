...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-04-27T14:44:32.746Z", actor: "recurring/feature-prioritise" }
---
...
- [ ] Write `docs/reports/simplifications-2026-04.md` using the report template below
- [ ] For **each** of the three picks, run `aigon feature-create "<short-kebab-name>" --description "<one-sentence summary; see report section N for full rationale>"`. Use a name like `simplify-<area>-2026-04` so the inbox stays tidy
- [ ] Commit the report and the three new spec files together: `git add docs/reports/simplifications-2026-04.md docs/specs/features/01-inbox/ && git commit -m "chore: top-3 simplifications report + inbox specs 2026-04"`
...
```sh
aigon feature-create "simplify-<short-area>-2026-04" --description "<one-sentence summary>. See docs/reports/simplifications-2026-04.md § <section> for scoring and proposed change."
```
...
Write the report to `docs/reports/simplifications-2026-04.md`:
...
**Inbox feature:** `simplify-<area>-2026-04` (filed via `feature-create`)
...
- Write to `docs/reports/simplifications-2026-04.md` and run `aigon feature-create` up to 3 times.
- Commit with message `chore: top-3 simplifications report + inbox specs 2026-04`.
