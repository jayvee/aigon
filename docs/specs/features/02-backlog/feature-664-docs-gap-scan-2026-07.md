...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-11T03:23:56.387Z", actor: "recurring/feature-prioritise" }
---

# docs-gap-scan-2026-07
...
- [ ] Commit all doc changes: `git add AGENTS.md docs/architecture.md docs/development_workflow.md site/content/ && git commit -m "docs: automated gap fixes 2026-W28"`
...
11. `git add AGENTS.md docs/architecture.md docs/development_workflow.md site/content/ && git commit -m "docs: automated gap fixes 2026-W28"`
