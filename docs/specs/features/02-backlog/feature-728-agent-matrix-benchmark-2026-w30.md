...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-25T13:13:42.488Z", actor: "recurring/feature-prioritise" }
---

# agent-matrix-benchmark-2026-W30
...
- [ ] Write a benchmark report to `.aigon/reports/agent-matrix-benchmark-2026-W30.md` with sections: Agent/Model, Task, Outcome (pass/fail), TypeScript clean (yes/no), Approach summary (2–3 sentences), Notable issues
- [ ] Close the feature (`aigon feature-close <ID>`) — report is gitignored, no separate commit needed
...
4. Write the benchmark report to `.aigon/reports/agent-matrix-benchmark-2026-W30.md` (in the aigon repo, not brewboard).
