...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-19T23:22:19.944Z", actor: "recurring/feature-prioritise" }
---

# model-catalog-intelligence-2026-W30
...
- [ ] Commit the applied changes as `chore(models): refresh op catalog 2026-W30`.
...
- [ ] Write `.aigon/reports/model-catalog-intelligence-2026-W30.md` using the template below.
...
Write to `.aigon/reports/model-catalog-intelligence-2026-W30.md`:
...
- [ ] `chore(models): refresh op catalog 2026-W30` — only if patches approved
...
- Write `.aigon/reports/model-catalog-intelligence-2026-W30.md`.
