...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-25T10:09:14.399Z", actor: "recurring/feature-prioritise" }
---

# workflow-state-integrity-2026-W30

## Summary

Run `aigon doctor` across all registered repos and write a state-health report to `.aigon/reports/workflow-state-2026-W30.md`. Surface snapshotless inbox entities, slug/numeric mismatches, and port conflicts without applying fixes. Close without evaluation when complete.
...
- [ ] Write findings to `.aigon/reports/workflow-state-2026-W30.md` with:
...
4. Write `.aigon/reports/workflow-state-2026-W30.md`
