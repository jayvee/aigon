...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-07-11T03:23:56.538Z", actor: "recurring/feature-prioritise" }
---

# model-catalog-intelligence-2026-W28
...
- [ ] Commit the applied changes as `chore(models): refresh op catalog 2026-W28`.
...
- [ ] Write `.aigon/reports/model-catalog-intelligence-2026-W28.md` using the template below.
...
Write to `.aigon/reports/model-catalog-intelligence-2026-W28.md`:
...
- [ ] `chore(models): refresh op catalog 2026-W28` — only if patches approved
...
- Write `.aigon/reports/model-catalog-intelligence-2026-W28.md`.
