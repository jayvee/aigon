...
transitions:
  - { from: "inbox", to: "backlog", at: "2026-06-17T23:12:28.929Z", actor: "cli/feature-prioritise" }
---

# dependency-triage-2026-W25

## Summary

Run the weekly dependency and package-supply-chain triage for the Aigon repo. Capture the current dependency-security signals, write a concise report to `.aigon/reports/dependency-triage-2026-W25.md`, and create + prioritise follow-up features only when the findings require code or dependency changes.

This is a triage task, not an auto-upgrade task. Do not update dependencies directly inside this feature unless the spec is explicitly revised to ask for that.
...
- [ ] Write `.aigon/reports/dependency-triage-2026-W25.md` with a concise summary of actionable findings and raw command outcomes
...
4. Write `.aigon/reports/dependency-triage-2026-W25.md` with:
   - headline summary
   - actionable findings
