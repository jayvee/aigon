...
Split lib/commands/setup.js (4200 lines, largest file in repo) into a setup/ submodule directory grouped by concern (seed-reset, worktree-cleanup, gitignore-and-hooks, pid-utils, agent-trust). See docs/reports/simplifications-2026-04.md section 1 for scoring and proposed change.
