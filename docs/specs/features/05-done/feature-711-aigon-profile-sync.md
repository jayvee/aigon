...
# Feature: aigon-profile-sync (F711)
...
- Depends on F708 (aigon-state-sync) being complete — it is.
...
- Prior feature: F708 (aigon-state-sync) — the project-level sync this extends
