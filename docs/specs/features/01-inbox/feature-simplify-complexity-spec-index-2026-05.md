...
# Feature: simplify-complexity-spec-index-2026-05
...
Wire readComplexityFromSpec through the already-built specIndex to eliminate per-feature readFileSync calls on every dashboard refresh. See docs/reports/simplifications-2026-05.md § 3 for scoring and proposed change.
