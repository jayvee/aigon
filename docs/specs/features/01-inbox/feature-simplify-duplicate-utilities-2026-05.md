...
# Feature: simplify-duplicate-utilities-2026-05
...
Centralize safeReadDir (×4), stripAnsi (×4), and safeStatMtimeMs (×2) into lib/fs-utils.js and replace all local copies with imports. See docs/reports/simplifications-2026-05.md § 1 for scoring and proposed change.
