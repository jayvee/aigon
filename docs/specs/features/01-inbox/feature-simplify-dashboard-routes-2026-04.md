...
Split lib/dashboard-routes.js (2079 lines, 40+ inline route definitions) into a per-domain dashboard-routes/ directory (recommendations, entities, set, config, analytics) so the top-level file becomes a small aggregator. See docs/reports/simplifications-2026-04.md section 3 for scoring and proposed change.
