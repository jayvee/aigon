...
Regenerate brewboard seed demo repo to match the new install contract from F2/F3/F4 (no AGENTS.md scaffold, vendored docs in .aigon/docs/, manifest-tracked install). Doubles as the migration test: a legacy-state copy of brewboard is run through aigon doctor --fix to verify migrations work.
