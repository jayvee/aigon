...
Replace agent-id if/else ladders (lib/session-sidecar.js, lib/telemetry.js, lib/commands/setup.js) with a data-driven capabilities registry sourced from templates/agents/<id>.json so adding a new agent is a one-JSON edit. See docs/reports/simplifications-2026-04.md section 2 for scoring and proposed change.
