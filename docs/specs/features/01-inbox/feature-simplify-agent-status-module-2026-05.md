...
# Feature: simplify-agent-status-module-2026-05
...
Extract the agent-status command (911 lines, 46% of misc.js) from lib/commands/misc.js into its own lib/commands/agent-status.js module. See docs/reports/simplifications-2026-05.md § 2 for scoring and proposed change.
