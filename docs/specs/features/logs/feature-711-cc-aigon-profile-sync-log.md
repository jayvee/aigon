...
### Notes
- Implementation matches F711 acceptance criteria: `sync.profileRemote`, `sync-core` extraction, dashboard dual panels, `/api/profile/status`, doctor notice, `/api/sync/status` for project timestamps.
