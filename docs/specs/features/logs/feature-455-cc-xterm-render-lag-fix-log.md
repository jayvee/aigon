...
Implemented all 5 changes: @xterm/xterm@5.5.0 pin + ImageAddon removal, lineHeight 1.0 + cursorBlink opt-in, rAF-debounced transition-aware ResizeObserver, Playwright globals assertion updated, 32 KB pty high-water-mark flush.
