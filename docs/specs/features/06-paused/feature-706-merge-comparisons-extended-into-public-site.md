...
>
> F399 delivers everything F706 proposed (rewritten `site/content/comparisons.mdx`, deletion of `docs/comparisons-extended.md`) plus the surrounding internal source of truth (`docs/competitive/`) and canonical positioning copy (`docs/marketing/positioning.md`). The two were folded together so the public page is grounded in an internal matrix rather than re-derived from scratch each time.
>
...
- [ ] Should we link to the research topics (research-21, research-65, research-25) as "further reading"?
...
- `research-65-roocode-comparison.md` — Roo Code details
