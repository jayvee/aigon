...
Sources: https://docs.paperclip.ing/start/architecture, https://docs.paperclip.ing/adapters/overview, [packages/adapter-utils/src/server-utils.ts](<home>/src/paperclip/packages/adapter-utils/src/server-utils.ts:1043), [packages/adapters/claude-local/src/server/execute.ts](<home>/src/paperclip/packages/adapters/claude-local/src/server/execute.ts:324), [packages/adapters/codex-local/src/server/execute.ts](<home>/src/paperclip/packages/adapters/codex-local/src/server/execute.ts:217)
...
Sources: [packages/db/src/schema/heartbeat_runs.ts](<home>/src/paperclip/packages/db/src/schema/heartbeat_runs.ts:6), [packages/db/src/schema/agent_runtime_state.ts](<home>/src/paperclip/packages/db/src/schema/agent_runtime_state.ts:5), [packages/db/src/schema/agent_task_sessions.ts](<home>/src/paperclip/packages/db/src/schema/agent_task_sessions.ts:6), [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:264), [server/src/services/run-log-store.ts](<home>/src/paperclip/server/src/services/run-log-store.ts:30)
...
Sources: [packages/adapter-utils/src/server-utils.ts](<home>/src/paperclip/packages/adapter-utils/src/server-utils.ts:1064), [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:2349)
...
Sources: [packages/adapter-utils/src/server-utils.ts](<home>/src/paperclip/packages/adapter-utils/src/server-utils.ts:1136), [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:3234)

Failure modes handled explicitly:
- Timeout: child gets `SIGTERM`, then `SIGKILL` after grace.  
  Source: [packages/adapter-utils/src/server-utils.ts](<home>/src/paperclip/packages/adapter-utils/src/server-utils.ts:1086)
- Missing/unknown session on resume: both Claude and Codex retry once with a fresh session.  
  Sources: [packages/adapters/claude-local/src/server/parse.ts](<home>/src/paperclip/packages/adapters/claude-local/src/server/parse.ts:170), [packages/adapters/claude-local/src/server/execute.ts](<home>/src/paperclip/packages/adapters/claude-local/src/server/execute.ts:617), [packages/adapters/codex-local/src/server/execute.ts](<home>/src/paperclip/packages/adapters/codex-local/src/server/execute.ts:618)
- Lost child process after server restart / handle loss: mark failed and queue one automated retry if eligible.  
  Sources: [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:2381), [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:2079)
...
Sources: [packages/adapters/claude-local/src/server/execute.ts](<home>/src/paperclip/packages/adapters/claude-local/src/server/execute.ts:155), [packages/adapters/codex-local/src/server/execute.ts](<home>/src/paperclip/packages/adapters/codex-local/src/server/execute.ts:292)
...
Sources: [server/src/services/run-log-store.ts](<home>/src/paperclip/server/src/services/run-log-store.ts:53), [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:3262), [server/src/services/heartbeat-run-summary.ts](<home>/src/paperclip/server/src/services/heartbeat-run-summary.ts:16)
...
Sources: [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:67), [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:309), [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:2500)
...
Sources: https://docs.paperclip.ing/guides/agent-developer/heartbeat-protocol, [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:1356)

### 7. Patterns Paperclip uses that Aigon does not, and could benefit from

Compared with Aigon's tmux + shell trap + status file + heartbeat-file model ([lib/worktree.js](<aigon>/lib/worktree.js:345), [lib/agent-status.js](<aigon>/lib/agent-status.js:73), [lib/workflow-heartbeat.js](<aigon>/lib/workflow-heartbeat.js:4), [lib/entity.js](<aigon>/lib/entity.js:804)), the highest-value Paperclip patterns are:
...
Sources: https://docs.paperclip.ing/adapters/codex-local, [packages/adapters/codex-local/src/server/execute.ts](<home>/src/paperclip/packages/adapters/codex-local/src/server/execute.ts:502)
...
- Paperclip code:
  - [packages/adapter-utils/src/server-utils.ts](<home>/src/paperclip/packages/adapter-utils/src/server-utils.ts:1043)
  - [packages/adapter-utils/src/session-compaction.ts](<home>/src/paperclip/packages/adapter-utils/src/session-compaction.ts:1)
  - [packages/adapters/claude-local/src/server/execute.ts](<home>/src/paperclip/packages/adapters/claude-local/src/server/execute.ts:324)
  - [packages/adapters/claude-local/src/server/parse.ts](<home>/src/paperclip/packages/adapters/claude-local/src/server/parse.ts:7)
  - [packages/adapters/codex-local/src/server/execute.ts](<home>/src/paperclip/packages/adapters/codex-local/src/server/execute.ts:217)
  - [packages/adapters/codex-local/src/server/parse.ts](<home>/src/paperclip/packages/adapters/codex-local/src/server/parse.ts:3)
  - [server/src/services/heartbeat.ts](<home>/src/paperclip/server/src/services/heartbeat.ts:264)
  - [server/src/services/run-log-store.ts](<home>/src/paperclip/server/src/services/run-log-store.ts:30)
  - [server/src/services/heartbeat-run-summary.ts](<home>/src/paperclip/server/src/services/heartbeat-run-summary.ts:16)
  - [packages/db/src/schema/heartbeat_runs.ts](<home>/src/paperclip/packages/db/src/schema/heartbeat_runs.ts:6)
  - [packages/db/src/schema/agent_task_sessions.ts](<home>/src/paperclip/packages/db/src/schema/agent_task_sessions.ts:6)
  - [packages/db/src/schema/agent_runtime_state.ts](<home>/src/paperclip/packages/db/src/schema/agent_runtime_state.ts:5)
- Aigon comparison points:
  - [lib/worktree.js](<aigon>/lib/worktree.js:345)
  - [lib/agent-status.js](<aigon>/lib/agent-status.js:73)
  - [lib/workflow-heartbeat.js](<aigon>/lib/workflow-heartbeat.js:4)
  - [lib/entity.js](<aigon>/lib/entity.js:804)
